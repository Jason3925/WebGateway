...
exports.virtualReceptionistShow = function(data, callback) {
  emitter.ivr.get('/api/virtual_receptionist/show', data, callback);
};
exports.virtualReceptionistCreate = function(data, callback) {
  emitter.post('/api/virtual_receptionist/create', data, callback);
};
exports.virtualReceptionistCreateIVR = function(data, callback) {
  emitter.ivr.post('/api/virtual_receptionist/create', data, callback);
};
exports.virtualReceptionistUpdate = function(data, callback) {
  emitter.post('/api/virtual_receptionist/update', data, callback);
};
exports.virtualReceptionistUpdateIVR = function(data, callback) {
  emitter.ivr.post('/api/virtual_receptionist/update', data, callback);
};
exports.virtualReceptionistDestroy = function(data, callback) {
  emitter.post('/api/virtual_receptionist/destroy', data, callback);
};
exports.virtualReceptionistDestroyIVR = function(data, callback) {
  emitter.ivr.post('/api/virtual_receptionist/destroy', data, callback);
};
