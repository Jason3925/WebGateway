...
function addTenantPost(req, res, next) {
  ...
  var result = {};
  ep.all('teData', function(teData) {
    //apiTenant.accountCreateVM(req.body, function(err, data) {
    //  //...
    //});
...
function updateTenantPost(req, res, next) {
  ...
  var result = {};
  ep.all('teData', function(teData) {
    //apiTenant.accountUpdateVM(req.body, function(err, data) {
    //  //...
    //});
    result['teData'] = teData;
    res.json(result).end();
...
function destroyTenantPost(req, res, next) {
  ...
  var result = {};
  ep.all('teData', function(teData) {
    //apiTenant.accountDestroyVM(req.body, function(err, data) {
    //  //...
    //});
    result['teData'] = teData;
    res.json(result).end();
